...
void Commands::TelemetryCommand(System& sm, const RnpPacketSerialized& packet)
{
	...
	processedSensorPacket.ch0sens = sm._pt0.getProcessed();
	processedSensorPacket.ch1sens = sm._pt1.getProcessed();
	processedSensorPacket.ch2sens = sm._pt2.getProcessed();

	processedSensorPacket.temp0 = sm._tc0.getProcessed();
	processedSensorPacket.temp1 = sm._tc0.getProcessed();
...
void Commands::rawADCCommand(System& sm, const RnpPacketSerialized& packet)
{
	...
	rawSensors.ch0 = sm._adc0.getOutput(0);
	rawSensors.ch1 = sm._adc0.getOutput(1);
	rawSensors.ch2 = sm._adc0.getOutput(2); 
